 ...
 *
 * Represents a Vertex in a graph. Vertices are connected to 
 * other Vertices via Edges. Each Vertex maintains a collection 
 * of all Edges that originate from it.
 *************************************************************/
class Vertex {
